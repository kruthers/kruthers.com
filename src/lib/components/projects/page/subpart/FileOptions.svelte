...
<td>
    <a role="button" class="btn btn-circle btn-info" href={file.link} rel="external" ><Icon icon="material-symbols:download-rounded" width="1.2em" height="1.2em" /></a>
    <div class="dropdown">
        ...
        <ul tabindex="-1" class="dropdown-content menu bg-base-100 rounded-box z-1 w-52 p-2 shadow-sm">
            <li><a href={file.link} rel="external"><Icon icon="material-symbols:download-rounded" width="1.2em" height="1.2em" /> Download</a></li>
            <li>
                <a href={resolve("/downloads/[slug]/files/[version]", { slug: file.project, version: file.id })}>
